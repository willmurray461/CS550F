...
def mandelbrot(sizex, sizey, accuracy):
	#initializes a new blank RGB image with a resolution of sizex x sizey
	...
	for x in range(0, sizey):
		for y in range(0, sizex):
			...
			counter = 0
			#This while loop checks how many times it takes Z to escape, or if it doesn't after 255 attempts
